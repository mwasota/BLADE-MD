...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '255716312895'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
global.sudo = process.env.SUDO || "255716312895"
...
module.exports = {
  ...
  packname:  process.env.PACK_NAME || 'MADE BY Xhriss md',
  ...
  caption :process.env.CAPTION || "MrXhristz,	
  ...
  LANG: process.env.THEME|| 'Xhrisstz',
